...
### Rand Construction
sprand(n::Integer, p::AbstractFloat, rfn::Function, ::Type{T}) where {T} = sprand(globalRNG(), n, p, rfn, T)
...
sprand(n::Integer, p::AbstractFloat, rfn::Function) = sprand(globalRNG(), n, p, rfn)
...
sprand(n::Integer, p::AbstractFloat) = sprand(globalRNG(), n, p, rand)
...
sprand(::Type{T}, n::Integer, p::AbstractFloat) where {T} = sprand(globalRNG(), T, n, p)

sprandn(n::Integer, p::AbstractFloat) = sprand(globalRNG(), n, p, randn)
